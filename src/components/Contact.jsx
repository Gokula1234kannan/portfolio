    ...
    >
      <div className="max-w-[90%] md:max-w-[75%] mx-auto font-inter space-y-10 py-10">
        <div className="text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-center text-[#3374ff]">
            Get in touch
          </h2>
        </div>
        <div className="flex flex-col items-center md:flex-row gap-[150px] justify-center">
          <div className="flex flex-col space-y-5 text-lg md:text-xl font-semibold">
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <div className="flex gap-4">
                <a
                  href="hhttps://github.com/Gokula1234kannan"
                  className="hover:text-[#3374ff]"
                >
                  <FaGithub size={29} />
                </a>
                <a
          ...
          >
            <h2 className="text-2xl font-bold text-[#3374ff] text-center">
              Send a Message
            </h2>
            <input
              type="text"
            ...
            <button
              type="submit"
              className="bg-[#3374ff] text-white py-3 rounded-md font-semibold hover:bg-[#abd0e8] disabled:opacity-50"
